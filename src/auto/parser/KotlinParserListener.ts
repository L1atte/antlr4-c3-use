...
import { VariableReadContext } from "./KotlinParser";
...
import { SuggestArgumentContext } from "./KotlinParser";
...
export interface KotlinParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	enterVariableRead?: (ctx: VariableReadContext) => void;
	/**
	 * Exit a parse tree produced by `KotlinParser.variableRead`.
	 * @param ctx the parse tree
	 */
	exitVariableRead?: (ctx: VariableReadContext) => void;
	 ...
	 * @param ctx the parse tree
	 */
	enterSuggestArgument?: (ctx: SuggestArgumentContext) => void;
	/**
	 * Exit a parse tree produced by `KotlinParser.suggestArgument`.
	 * @param ctx the parse tree
	 */
	exitSuggestArgument?: (ctx: SuggestArgumentContext) => void;
